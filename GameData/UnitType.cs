...
namespace GameData
{
    ...
    {
        public static readonly UnitType Invalid = new UnitType(-1, "Invalid", 0, MovementType.Invalid);
        ...
        public static UnitType Create(int id, string name, int moves, object p)
        {
